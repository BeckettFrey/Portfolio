...
import type { PhotoGridProps, PhotoItem } from './types';
import { useIsMobile } from '@/utils/hooks/useIsMobile';

const Main = ({ selectedPhoto, setSelectedPhoto, config }: PhotoGridProps & { config: PhotoItem[] }) => {
  const isMobile = useIsMobile(768);
  const photosArray = config;
