...
const FlappyBird = () => {
  ...
  useEffect(() => {
    const updateDimensions = () => {
      ...
      if (isMobile) {
        const maxWidth = Math.min(screenWidth - 32, 360); // Adjusted for CorePage's px-6 (12px per side)
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      {/* Game Board */}
      <div className="bg-white/10 backdrop-blur-md rounded-2xl shadow-xl p-4 border border-white/10 mb-4 game-container">
        <div 
